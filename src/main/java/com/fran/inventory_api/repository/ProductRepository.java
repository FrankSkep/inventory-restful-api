...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    @Query("SELECT new com.fran.inventory_api.dto.ProductResponseBasic(p.id, p.nombre, p.descripcion, p.precio, p.cantidadStock, p.category.nombre, p.image.url) FROM Product p")
